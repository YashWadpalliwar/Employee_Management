...
public class Salary extends JFrame implements ActionListener{
    ...
    Salary(){
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("Employee_Management/icons/empng.png"));
        ...
        ch1.addMouseListener(new MouseAdapter ()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    String q3 = "select * from employee where empID='"+eid2+"'";                 
        ...
        if(e.getSource()==bt1){
            ...
            String month=ch2.getSelectedItem()+" "+ch3.getSelectedItem();
             ...
             try{
                 ...
                 String q1 = "insert into salary values('"+0+"','"+empID+"','"+name+"','"+email+"','"+hra+"','"+da+"','"+mid+"','"+pf+"','"+basic+"','"+month+"')";
